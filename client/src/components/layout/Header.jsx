...
import { FaAlignJustify, FaSistrix, FaFilter, FaAngleLeft } from "react-icons/fa6";
...
const Header = () => {
	...
	return (
		<HeaderBlock>
			...
			<HeaderBack className={`HeaderBack ${sidebarActive && "active"}`} onClick={onClickBack}></HeaderBack>
		</HeaderBlock>
	);
};
