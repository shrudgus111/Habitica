...
const RewardButton = ({ onClickModal, selectedReward }) => {
	...
	return (
		<RewardButtonBlock className="FL_SB DefaultWidth">
			...
			<button className="buy FontMenuTitle FL_Center" onClick={onClickClose}>
				<img src="../src/assets/image/coin.svg" alt="코인" className="coinIcon" />
